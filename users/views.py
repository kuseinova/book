...
from books.utils import IsOwnerAccount, send_activation_email
from users.serializers import ProfileSerializer, LoginSerializer, RegisterSerializer
...
class ActivationView(APIView):
    ...
    def get(self, request, activation_code):
        ...
        user.save()
        return Response(
            'your acc suc activated.', status=status.HTTP_200_OK
        )
...
class LogoutView(APIView):
    ...
    def post(self, request):
        ...
        return Response(
            'You successfully logout from account'
        )
